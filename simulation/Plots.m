...
%hold on;
errorbar(log(1:250:n),regret_AB_mean(1:250:n), regret_AB_var(1:250:n), regret_AB_var(1:250:n), 'kx','LineWidth',1.5);
...
%hold on;
errorbar(sqrt(1:250:(n)),regret_AB_mean(1:250:(n)), regret_AB_var(1:250:(n)), regret_AB_var(1:250:(n)), 'kx','LineWidth',1.5);
